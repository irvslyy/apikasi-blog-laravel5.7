      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                 ...
                 @foreach($users as $pengguna) @endforeach
            <div class="d-sm-none d-lg-inline-block">{{$pengguna->name}}</div></a>
          ...
          <div class="section-header">
            <form>
              ...
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="your email" value="{{$pengguna->name}}">
              </div>
              <div class="form-group">
                <label for="exampleInputPassword1">email</label>
                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="your password" value="{{$pengguna->email}}">
              </div>
