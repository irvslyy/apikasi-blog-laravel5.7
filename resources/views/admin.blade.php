        ...
        <section class="section">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <div class="table-links">
                              ...
                              <a href="{{route('blog_path', ['blog' => $blog->id])}}">View</a>
                            </div>
                          </td>
                          <td>
                          ...
                          <td>
                            <a href="#" class="font-weight-600"><img src="{{asset($blog->image)}}" alt="avatar" width="30" class=" mr-1"></a>
                          </td>
                          <td>
                            <a href="{{route('edit_blog_path', ['blog' => $blog->id])}}" class="btn btn-primary btn-action mr-1" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>


                             <form action="{{route('delete_blog_path', ['blog' => $blog->id])}}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger btn-action"  data-toggle="tooltip" title="Delete" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" data-confirm-yes="alert('Deleted')"><i class="fas fa-trash"></i></button>
                              </form>
          ...
          <div class="row">
            ...
            <div class="col-lg-8 col-md-12 col-12 col-sm-12">
              <div class="card">
                <div class="card-header"><div id="myWeather">Create content</div></div>
                   ...
                   <div class="card-body">
                    <form action="{{route('store_blog_path')}}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="content" rows="10" class="form-control texteditor content" id="texteditor"></textarea>
                      </div>
            ...
            <div class="col-lg-4 col-md-12 col-12 col-sm-12">
              <div class="card">
                ...
                <div class="card-body">
                       <div id="myWeather">Featured Image</div>
                       <div class="form-group">
